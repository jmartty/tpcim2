...
$(function() {
    ...
    var container = $("#flot-line-chart-moving-hume");
    ...
    function getRandomData() {
        ...
        while (data.length < maximum) {
            ...
            var y = previous + (Math.random() * 10 - 5)*0.25;
...
$(function() {
    ...
    var container = $("#flot-line-chart-moving-temp");
    ...
    function getRandomData() {
        ...
        while (data.length < maximum) {
            var previous = data.length ? data[data.length - 1] : 18;
            var y = previous + (Math.random() -0.5 )*0.1
            data.push(y < 10 ? 10 : y > 30 ? 30 : y);
        }
